...
//        int x;
//        if (x > 10 && x < 20) System.out.println();
//        char형 변수 ch가 공백이나 탭이 아닐 때 true인 조건식
//        char ch;
//        if (ch != ' ' || ch != '\t') System.out.println();
        //char형 변수 ch가 'x' 또는 'X'일 때 true인 조건식
//        if (ch == 'x' || ch == 'X') System.out.println();

        //char형 변수 ch가 숫자('0'~'9')일 때 true인 조건식
//        if ('0'<= ch && ch<= '9') System.out.println();

        //char형 변수 ch가 영문자(대문자 또는 소문자)일 때 true인 조건식
//        if (('A' <= ch && ch <= 'Z') || ('a' <= ch && ch <= 'z')) System.out.println();
...
//        boolean powerOn;
//        if (!powerOn) System.out.println();

        //문자열 참조변수 str이 "yes"일 때 true인 조건식
//        String str;
//        if (str.equals("yes")) System.out.println();
    }
}
...
class Exercise4_8 {
    public static void main(String[] args) {
//        int value = ((int) (7 * Math.random())); // 0부터임
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (input > answer) {
                ...
                System.out.printf("정답: %d, %d번 만에 맞췄습니다.", answer, count);
                break;
            }
        } while (true); //무한반복문
    } // end of main 
